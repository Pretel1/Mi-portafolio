...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Reconstrucción dinámica del correo para evitar spambots rastreando la cadena estática.
      // Se recomienda registrar un token hash en FormSubmit.co para mayor privacidad y usarlo aquí en lugar del email.
      const formEndpoint = `https://formsubmit.co/ajax/${EMAIL_ADDRESS}`;
  ...
  const handleWhatsApp = () => {
    ...
    // Agregamos 'noopener,noreferrer' para evitar vulnerabilidades de reverse tabnabbing
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="flex flex-col gap-8 w-full">
            ...
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              className="space-y-8 terminal-window p-8 w-full"
            >
            ...
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              className="terminal-window p-8 flex flex-col items-center justify-center text-center relative overflow-hidden w-full"
            >
              <div className="terminal-header -mx-8 -mt-8 mb-8 w-[calc(100%+4rem)]">
                <div className="terminal-dot dot-red" />
                <div className="terminal-dot dot-yellow" />
                <div className="terminal-dot dot-green" />
                <span className="ml-4 text-xs font-mono text-text-muted">qr_code.png</span>
              </div>
              
              <div className="relative p-3 bg-dark-950 border border-white/10 rounded shadow-[0_0_15px_rgba(0,242,254,0.1)] select-none">
                <img
                  src="https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=https://pretel1.github.io/Mi-portafolio/&color=00f2fe&bgcolor=050505"
                  alt="Código QR del Portafolio"
                  className="w-44 h-44 pointer-events-none select-none filter brightness-[0.95]"
                  loading="lazy"
                />
                {/* Transparent pointer event absorber overlay overlaying the QR image to block right clicks/downloads */}
                <div className="absolute inset-0 bg-transparent pointer-events-auto cursor-default" onContextMenu={(e) => e.preventDefault()} />
              </div>
