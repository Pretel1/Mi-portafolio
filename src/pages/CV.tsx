    ...
    >
      <div className="w-full px-4 sm:px-8 lg:px-12 mx-auto">
        ...
        <div className="max-w-4xl mx-auto mb-10 no-print flex flex-col sm:flex-row items-center justify-between gap-4 p-4 rounded-lg border border-neon-cyan/20 bg-dark-900/80 backdrop-blur-md">
          ...
          <button
            onClick={handlePrint}
            className="flex items-center gap-2 px-6 py-2.5 bg-neon-cyan text-black text-xs font-mono font-bold uppercase tracking-wider rounded hover:bg-white hover:shadow-[0_0_20px_rgba(0,242,254,0.4)] transition-all duration-300 cursor-pointer"
          >
